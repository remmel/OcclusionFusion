#  The file contains tests for the tsdf integration part
# Basically we want to integrate the first source frame and compare with open3d whether we are getting correct output 
# Also we want to check whether the implementation of marching cubes is working
...
def test1(use_gpu=True,debug=False):
	...
	fopt = Dict2Class({"voxel_dim":128,"voxel_size":None,"source_frame":0,"gpu":use_gpu,"visualizer":"open3d","datadir":"/media/srialien/Elements/AT-Datasets/DeepDeform/new_test/mannequin_Running_cam1/"})
